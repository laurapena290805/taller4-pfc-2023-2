...
class Recursiva {
  ...
  def multMatrizRecPar(m1: obj.Matriz, m2: obj.Matriz): obj.Matriz = {
    val n: Int = m1.map(_ => 1).foldLeft(0)(_ + _)
    val z = n / 2
    n match {
      case 1 => Vector(Vector(m1(0)(0) * m2(0)(0)))
      case _ => {
        ...
        val m2_3 = subMatriz(m2, z, 0, z)
        val m2_4 = subMatriz(m2, z, z, z)
        val (p1, p2, p3, p4) = parallel(sumMatriz(multMatrizRec(m1_1, m2_1), multMatrizRec(m1_2, m2_3)),
          sumMatriz(multMatrizRec(m1_1, m2_2), multMatrizRec(m1_2, m2_4)),
          sumMatriz(multMatrizRec(m1_3, m2_1), multMatrizRec(m1_4, m2_3)),
          sumMatriz(multMatrizRec(m1_3, m2_2), multMatrizRec(m1_4, m2_4)))
